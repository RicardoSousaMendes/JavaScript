...
const product1 = { id: 1, name: 'Couves', price: 66 };
const product2 = { id: 2, name: 'Agrião', price: 49 };
...
ecommerce.addProduct({ id:3, name: 'Laranjas', price: 987});

// Obter todos os produtos
console.log(ecommerce.getAllProducts());

// Atualizar o preço de um produto
ecommerce.setProductPrice(5, 987);
...
console.log(ecommerce.getProductByName('Couves'));

// Obter produtos por faixa de preço
console.log(ecommerce.getProductsByPrice(10, 20));
