...
const companiesStartDate = (inicio) => {
   return companies.filter((company) => company.start > inicio);
};
console.log(companiesStartDate(1987));
...
// function companiesData(companies) {
//     return companies.some(company => company.start >= 1996 && company.start <= 2004);
// }
